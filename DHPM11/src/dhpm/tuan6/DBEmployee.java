...
public class DBEmployee extends javax.swing.JFrame {
    ...
    private List<Employee> getAllEmployee() throws SQLException{
       ...
       private  void showEmployee() throws SQLException{
        ...
        for(int i = 0 ; i < listAllE.size(); i++){
            ...
            row[4] = listAllE.get(i).getKnowledge();
    ...
    private void initComponents() {
        ...
        cboSubject.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bussiness", "Management", "Education", "Developer", " " }));
    ...
    private void tblListEmployeeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListEmployeeMouseClicked
        // TODO add your handling code here:
        int i = tblListEmployee.getSelectedRow();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        sql = " UPDATE Employee SET name = ?, address = ?"
                    +", gender=?, knowledge =?, subject=? "
                    +" WHERE id = " + id;
        PreparedStatement preStmt = null;
        strName = txtName.getText();
        strAddress = txtAddress.getText();
        ...
        try {
            ...
            // làm mới dữ liệu
            showEmployee();
            JOptionPane.showMessageDialog(null, "Sửa chữa được lưu thành công");
            System.out.println("Số dòng " + row);
        } catch (SQLException ex) {
            Logger.getLogger(DBEmployee.class.getName()).log(Level.SEVERE, null, ex);
        }
